...
\paragraph{Ingredients for pork marinate:}
\begin{itemize}
	\item 2 lb of pork loin
	\item 4 garlic cloves minced
	\item 1 tsp salt
	\item 1/2 cup white wine
\end{itemize}

\paragraph{Directions for pork marinate:}
\begin{itemize}
	\item Put all marinate ingredients in a small container in the fridge and let it sit overnight.
\end{itemize}
...
\begin{itemize}
	...
	\item marinated pork, chopped into cubes.
	\item bunch of parsley, chopped
	\item 1/2 large onion, chopped
	\item 1 leek, chopped (white and green part)
	\item 2 tomatoes, chopped
	\item 1 tbl spoon tomato paste
	\item 4 garlic cloves, minced
	\item 1/2 cup of wine
	
\end{itemize}

\paragraph{Directions stew:}
\begin{itemize}
	\item Sear the bacon first, until browned. Reserve.
	\item With the bacon fat, sear the chopped pork. Reserve
	\item With the bacon fat, sear lightly the sausage. Reserve
	\item With the bacon fat (maybe add some oil if the fat is gone), add onion and leek
	\item Once onion is translucent add garlic until fragrant. 
	\item Then Deglaze the pan with the wine, then add tomatoes, parsley, tomato paste all other cooked ingredients (beans and meat)
	\item Cook in the oven (with a dutch oven) on 325F for 1hr.
\end{itemize}
