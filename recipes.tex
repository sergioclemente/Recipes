...
\item add the remaining ingredients to the pan. Lower the heat, flip the side of the chicken, add a lid and let it simmer for 10-15min.
\item If you have a temperature probe, ensure the internal temperature reaches 165°F (74°C)
\end{itemize}
...
\subsection{Leozin Meat Marinate}
...
\subsection{Pork on Mustard and Vinegar}
...
\begin{itemize}
	...
	\item Mexican Spice Blend (2 teaspoon paprika, 2 teaspoon chili powder, 1/2 teaspoon garlic salt, 1/2 teaspoon onion salt, 1 teaspoon cumin, pepper to taste)
\end{itemize}
...
\item 1/2 teaspoon pepper or to taste
\item pinch teaspoon nutmeg ground
...
\subsection{Beans on tomato sauce (Luzinete Style)}
...
\subsection{Chef Zeca - Bacalhau gomes sa}
...
\begin{itemize}
	...
	\item tomato sauce
	\item 2-3 tablespoon red palm oil (NUTIVA)
	\item 2-3 tablespoon olive oil
	\item salt
	\item black pepper
\end{itemize}
...
\begin{itemize}
  ...
  \item 1 teaspoon fresh ginger minced
  \item 3 cloves garlic minced
  \item salt and pepper to taste
...
\begin{itemize}
	...
	\item 1 cup and 1 tablespoon Flour
	\item 2 tablespoon Butter
...
\begin{itemize}
	...
	\item Add 1 tablespoon of gee or butter with some olive oil in a skillet (don't use a non-stick one).
...
\begin{itemize}
	...
	\item 1/2 teaspoon tumeric
	\item 2 teaspoon cumin powder
...
\begin{itemize}
	...
	\item 2 teaspoon fresh ginger minced (or paste)
	\item 1 cup tomato puree or passata
	\item 2 tbsp tomato paste
	\item 3 teaspoon garam masala
...
\begin{itemize}
\item 1 teaspoon vanilla bean paste
\item 6 egg yolks
...
\begin{itemize}
  ...
  \item 1/2 teaspoon red pepper flakes
  \item 1/2 teaspoon salt
  \item 1/2 teaspoon black pepper freshly ground	
\end{itemize}
...
\begin{itemize}
	...
	\item 1/2 teaspoon of pumping pie spice (1/2 teaspoon cinnamon, 1/8 teaspoon nutmet, 1/8 teaspoon ginger). I actually like more like 8:1:2 the proportions between (cinnamon, nutmeg and ginger).
	\item (optional) 1 1/2 teaspoon maple syrup
\end{itemize}
...
\begin{itemize}
	...
	\item Taste and depending on acidity add some sugar (1-2 teaspoon of coconut sugar). Make sure to balance with salt for sweetness.
\end{itemize}
...
\begin{itemize}
	...
	\item 1 teaspoon of baking soda (Try baking powder)
	\item 1 teaspoon of xanthan gum (Bob Mills)
	\item 1/3 cup of water (*try more water)
	\item 1 teaspoon of cinnamon (*try more)
\end{itemize}
...
\begin{itemize}
	...
	\item Make an egg scramble then add the remaining ingredients to the pan
...
\begin{itemize}
	\item 2 teaspoon of garam masala
	\item 1/8 teaspoon of cardamom
	\item 1/2 teaspoon ground turmeric
	\item 1/2 teaspoon red pepper
	\item 1 teaspoon cumin
\end{itemize}
