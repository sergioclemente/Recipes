...
\chick{Curry Chicken}{Knoor, Curry, Coconut oil}{}
...
\begin{itemize}
	\item Preheat the oven to 475°F. 
...
\paragraph{Directions (Chicken):}
\begin{itemize}
	\item On a sautee pan use something for making the sauce (Balsamic vinagrette or garlic and orange)
	\item Add juices from the chicken sheet pan.
	\item Let it reduce
...
Notes: You can replace the panko breakcrumb with tempura batter. The ingredients are: Tempura mix, cold water, salt and water.
